...
class StageController:
    ...
    def __init__(self):
        ...
        try:
            ...
            self.setResolution(self.axis1_resolution_um, self.axis2_resolution_um)
    ...
    def setSpeed(
        ...
        print(f"D:WS{ax1_min_speed}F{ax1_max_speed}R{ax1_acceleration}S{ax2_min_speed}F{ax2_max_speed}R{ax2_acceleration}")
        self.waitReady()
