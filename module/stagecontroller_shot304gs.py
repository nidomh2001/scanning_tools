...
class StageController:
    ...
    def setResolution(self, axis1_resolution=1, axis2_resolution=1, axis3_resolution=1, axis4_resolution=1):
        ...
        self.stage.write(f"S:3{axis3_resolution}")
        self.stage.write(f"S:4{axis4_resolution}")
    ...
    def moveAbs(self, axis, position_um, direction='+', wait_time_s=0.0):
        ...
        if axis == 1:
            ...
            num_pulse = int(position_um / self.axis3_resolution_um)
        elif axis == 4:
            num_pulse = int(position_um / self.axis4_resolution_um)
        else:
    ...
    # 相対位置移動
    def moveRel(self, axis, position_um, direction='+', wait_time_s=0.0):
        if not self.check_connection():
            return
        if axis == 1:
            num_pulse = int(position_um / self.axis1_resolution_um)
